...
namespace ASP_spr321.Migrations
{
    ...
    [Migration("20250412092326_AddTokin")]
    partial class AddTokin
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASP_spr321.Data.Entities.CartItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ASP_spr321.Data.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ASP_spr321.Data.Entities.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ASP_spr321.Data.Entities.UserAccess", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ASP_spr321.Data.Entities.UserData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ASP_spr321.Data.Entities.UserRole", b =>
                {
            ...
            modelBuilder.Entity("ASP_spr321.Data.Entities.Cart", b =>
                {
                    b.HasOne("ASP_spr321.Data.Entities.UserAccess", "UserAccess")
                        .WithMany()
            ...
            modelBuilder.Entity("ASP_spr321.Data.Entities.CartItem", b =>
                {
                    b.HasOne("ASP_spr321.Data.Entities.Cart", "Cart")
                        .WithMany("CartItems")
                        .HasForeignKey("CartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ASP_spr321.Data.Entities.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("ASP_spr321.Data.Entities.Category", b =>
                {
                    b.HasOne("ASP_spr321.Data.Entities.Category", "ParentCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("ASP_spr321.Data.Entities.Product", b =>
                {
                    b.HasOne("ASP_spr321.Data.Entities.Category", "Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ASP_spr321.Data.Entities.Category", null)
                        .WithOne("Product")
                        .HasForeignKey("ASP_spr321.Data.Entities.Product", "CategoryId1");
            ...
            modelBuilder.Entity("ASP_spr321.Data.Entities.UserAccess", b =>
                {
                    b.HasOne("ASP_spr321.Data.Entities.UserRole", "UserRole")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ASP_spr321.Data.Entities.UserData", "UserData")
                        .WithMany()
